...
\subsection{The nilpotent singular support condition}
...
%where we abuse the notation and see $\Pi_{x, 1}$ as an element in $D_{lis}^{C_{\varphi}}(Bun_G, \overline{\mathbb{Z}_{\ell}})^{\omega}$ via 
